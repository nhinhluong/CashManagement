...
/**
 * Provides the local service interface for MtbStoreUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MtbStoreUserLocalServiceUtil
...
public interface MtbStoreUserLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MtbStoreUserLocalServiceUtil} to access the mtb store user local service. Add custom service methods to {@link com.bmq.vn.service.impl.MtbStoreUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

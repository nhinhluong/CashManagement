...
/**
 * The persistence interface for the mtb store user service.
 *
 * <p>
 ...
 * @see MtbStoreUserUtil
 * @generated
 */
@ProviderType
public interface MtbStoreUserPersistence extends BasePersistence<MtbStoreUser> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MtbStoreUserUtil} to access the mtb store user persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<MtbStoreUser> mtbStoreUsers);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MtbStoreUser> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MtbStoreUser> findAll();
	...
	*/
	public java.util.List<MtbStoreUser> findAll(int start, int end);
	...
	*/
	public java.util.List<MtbStoreUser> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MtbStoreUser> orderByComparator);

...
/**
 * The persistence utility for the sitb store info service. This utility wraps {@link com.bmq.vn.service.persistence.impl.SitbStoreInfoPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class SitbStoreInfoUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(SitbStoreInfo sitbStoreInfo) {
		getPersistence().clearCache(sitbStoreInfo);
	}
	 ...
	 */
	public static List<SitbStoreInfo> findWithDynamicQuery(
	 ...
	 */
	public static SitbStoreInfo update(SitbStoreInfo sitbStoreInfo) {
		return getPersistence().update(sitbStoreInfo);
	}
	...
	public static SitbStoreInfo update(SitbStoreInfo sitbStoreInfo,
		...
		return getPersistence().update(sitbStoreInfo, serviceContext);
	}
	...
	*/
	public static void cacheResult(SitbStoreInfo sitbStoreInfo) {
		getPersistence().cacheResult(sitbStoreInfo);
	}
	...
	*/
	public static void cacheResult(List<SitbStoreInfo> sitbStoreInfos) {
		getPersistence().cacheResult(sitbStoreInfos);
	}
	...
	*/
	public static SitbStoreInfo create(long store_info_id) {
		return getPersistence().create(store_info_id);
	}
	...
	*/
	public static SitbStoreInfo remove(long store_info_id)
		throws com.bmq.vn.exception.NoSuchSitbStoreInfoException {
		return getPersistence().remove(store_info_id);
	}

	public static SitbStoreInfo updateImpl(SitbStoreInfo sitbStoreInfo) {
		return getPersistence().updateImpl(sitbStoreInfo);
	}
	...
	* @throws NoSuchSitbStoreInfoException if a sitb store info with the primary key could not be found
	*/
	public static SitbStoreInfo findByPrimaryKey(long store_info_id)
		throws com.bmq.vn.exception.NoSuchSitbStoreInfoException {
		return getPersistence().findByPrimaryKey(store_info_id);
	}
	...
	*/
	public static SitbStoreInfo fetchByPrimaryKey(long store_info_id) {
		return getPersistence().fetchByPrimaryKey(store_info_id);
	}

	public static java.util.Map<java.io.Serializable, SitbStoreInfo> fetchByPrimaryKeys(
	...
	*/
	public static List<SitbStoreInfo> findAll() {
	...
	*/
	public static List<SitbStoreInfo> findAll(int start, int end) {
	...
	*/
	...
	public static SitbStoreInfoPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<SitbStoreInfoPersistence, SitbStoreInfoPersistence> _serviceTracker =
		ServiceTrackerFactory.open(SitbStoreInfoPersistence.class);
}
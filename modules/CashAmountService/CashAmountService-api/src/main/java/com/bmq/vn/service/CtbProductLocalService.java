...
/**
 * Provides the local service interface for CtbProduct. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CtbProductLocalServiceUtil
...
public interface CtbProductLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CtbProductLocalServiceUtil} to access the ctb product local service. Add custom service methods to {@link com.bmq.vn.service.impl.CtbProductLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CtbProduct addCtbProduct(CtbProduct ctbProduct);
	...
	*/
	public CtbProduct createCtbProduct(long product_id);
	...
	*/
	...
	public CtbProduct deleteCtbProduct(CtbProduct ctbProduct);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CtbProduct deleteCtbProduct(long product_id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CtbProduct fetchCtbProduct(long product_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CtbProduct getCtbProduct(long product_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CtbProduct updateCtbProduct(CtbProduct ctbProduct);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CtbProduct> getCtbProducts(int start, int end);

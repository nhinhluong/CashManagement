...
/**
 * Provides the local service interface for CtbStoreType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CtbStoreTypeLocalServiceUtil
...
public interface CtbStoreTypeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CtbStoreTypeLocalServiceUtil} to access the ctb store type local service. Add custom service methods to {@link com.bmq.vn.service.impl.CtbStoreTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

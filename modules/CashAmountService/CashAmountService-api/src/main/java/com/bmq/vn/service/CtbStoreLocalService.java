...
/**
 * Provides the local service interface for CtbStore. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CtbStoreLocalServiceUtil
...
public interface CtbStoreLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CtbStoreLocalServiceUtil} to access the ctb store local service. Add custom service methods to {@link com.bmq.vn.service.impl.CtbStoreLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CtbStore addCtbStore(CtbStore ctbStore);
	...
	*/
	public CtbStore createCtbStore(long store_id);
	...
	*/
	...
	public CtbStore deleteCtbStore(CtbStore ctbStore);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CtbStore deleteCtbStore(long store_id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CtbStore fetchCtbStore(long store_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CtbStore getCtbStore(long store_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CtbStore updateCtbStore(CtbStore ctbStore);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CtbStore> getCtbStores(int start, int end);

...
/**
 * Provides the local service interface for CtbReason. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CtbReasonLocalServiceUtil
...
public interface CtbReasonLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CtbReasonLocalServiceUtil} to access the ctb reason local service. Add custom service methods to {@link com.bmq.vn.service.impl.CtbReasonLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CtbReason addCtbReason(CtbReason ctbReason);
	...
	*/
	public CtbReason createCtbReason(long reason_id);
	...
	*/
	...
	public CtbReason deleteCtbReason(CtbReason ctbReason);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CtbReason deleteCtbReason(long reason_id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CtbReason fetchCtbReason(long reason_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CtbReason getCtbReason(long reason_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CtbReason updateCtbReason(CtbReason ctbReason);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CtbReason> getCtbReasons(int start, int end);

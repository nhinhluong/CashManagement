...
<portlet:actionURL name="addAgent" var="addagent" >
	<portlet:param name="mvcActionCommand" value="addAgent" />
</portlet:actionURL>

<div data-reactroot="" class="container BMQCollectMoney">
	<div class="text-center">
		<h1 class="page-title">THU TIỀN ĐẠI LÝ</h1>
	</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-2">
					<div class="form-group">
						...
						<div>
							<aui:input id="_BmqCollectMoney_date_collect"
		...
		<c:forEach items="<%=CtbStoreLocalServiceUtil.getCtbStores(0, 50)%>"var="stores" > 
			<aui:form action="<%=addagent%>" method="post" name="fm2" id="fm2" >									
			<section>					
				<div class="row">				
					<div class="col-xs-12 col-sm-3">
						<div class="form-group">
							...
							<div>
								<aui:input id="moneyCollectionStoreName" 
									name="moneyCollectionStoreName" class="form-control"
									value="${stores.getStore_name()}" label=""/>

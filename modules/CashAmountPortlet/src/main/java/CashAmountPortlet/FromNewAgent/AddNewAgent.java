...
@Component(
		property = {
			...
			"mvc.command.name=addNewAgent",
		},
		service = MVCActionCommand.class
	)
public class AddNewAgent extends BaseMVCActionCommand {
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		long moneyCollectionReasonId = ParamUtil.getLong(actionRequest, "moneyCollectionReasonId");	
